        ...
        <div className="container px-6 py-10 mx-auto">
            <div className="mt-8 lg:-mx-6 lg:flex lg:items-center">
                ...
                <div className="mt-6 lg:w-1/2 lg:mt-0 lg:mx-6 ">
                    <h1 className="mb-4 text-4xl font-extrabold leading-none tracking-tight text-white md:text-5xl lg:text-6xl">Julio is a<span className="text-primary"> front-end developer</span> from El Salvador</h1>
                ...
                <img className="object-cover w-full lg:mx-6 lg:w-1/2 rounded-xl h-72 lg:h-96" src="src\utilities\firstImage.png" alt="" />
