        ...
        <div className="relative inline-block">
            ...
            {isOpen && (
                <div
                    ...
                    className="absolute right-0 z-20 w-full py-2 mt-2 origin-top-right bg-transparent rounded-md "
                >
                    <button
                        className="block w-full px-4 py-2 text-sm text-white capitalize transition-colors duration-300 transform hover:bg-primary100"
